...
{{/*
Name of the component konga.
*/}}
{{- define "konga.name" -}}
{{- printf "%s-konga" (include "kong.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified component konga name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
If release name contains chart name it will be used as a full name.
*/}}
{{- define "konga.fullname" -}}
{{- printf "%s-konga" (include "kong.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}


{{/*
Component konga labels
*/}}
{{- define "konga.labels" -}}
...
{{/*
Component konga selector labels
*/}}
...
*/}}
{{- define "backend.name" -}}
{{- printf "%s-backend" (include "kong.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-backend" (include "kong.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-frontend" (include "kong.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-frontend" (include "kong.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{/*
Name of the component frontendconfig.
*/}}
{{- define "frontendconfig.name" -}}
{{- printf "%s-frontendconfig" (include "kong.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified component frontendconfig name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
If release name contains chart name it will be used as a full name.
*/}}
{{- define "frontendconfig.fullname" -}}
{{- printf "%s-frontendconfig" (include "kong.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Component frontendconfig labels
*/}}
{{- define "frontendconfig.labels" -}}
helm.sh/chart: {{ include "kong.chart" . }}
{{ include "frontendconfig.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{/*
Component frontendconfig selector labels
*/}}
{{- define "frontendconfig.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kong.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
enabler: {{ .Chart.Name }}
app.kubernetes.io/component: frontendconfig
isMainInterface: "no"
tier: internal
{{- end }}
